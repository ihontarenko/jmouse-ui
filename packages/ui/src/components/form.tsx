...
function FormLabel({
  ...
  return (
    <Label
      ...
      data-error={!!error}
      className={cn("data-[error=true]:text-destructive-ink", className)}
      htmlFor={formItemId}
      {...properties}
    />
  )
...
function FormControl({ ...properties }: React.ComponentProps<typeof Slot.Root>) {
...
function FormMessage({ className, ...properties }: React.ComponentProps<"p">) {
  ...
  return (
    <p
      ...
      id={formMessageId}
      className={cn("text-[11px] text-destructive-ink", className)}
      {...properties}
    >
      {body}
    </p>
